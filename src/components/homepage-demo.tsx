        ...
        {viewMode === "grid" ? (
          ...
          >
            ...
            <div className="sticky bottom-0 z-10 flex justify-center pb-[24px] pt-[12px] pointer-events-none">
              ...
              >
                <span className="absolute inset-0 -translate-x-full animate-[shimmer_3s_linear_infinite]" style={{ background: "linear-gradient(105deg, transparent 20%, rgba(255,255,255,0.2) 45%, rgba(255,255,255,0.35) 50%, rgba(255,255,255,0.2) 55%, transparent 80%)" }} />
                {settings.cta_text}
              </button>
            </div>
          </div>
