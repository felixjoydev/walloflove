...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-sm">
      <h1 className="text-2xl font-bold">Log in to SignBoard</h1>
      <p className="mt-1 text-sm text-neutral-500">
        Welcome back. Sign in to manage your guestbooks.
      </p>

      <button
        type="button"
        onClick={handleGoogleLogin}
        className="mt-6 flex w-full items-center justify-center gap-3 rounded-lg border border-neutral-300 px-4 py-2.5 text-sm font-medium hover:bg-neutral-50"
      >
